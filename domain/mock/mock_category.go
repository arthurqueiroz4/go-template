...
//
//	mockgen -source=category.go -destination=./mock/mock_category.go
//
...
func (m *MockCategoryRepository) FindAll(arg0, arg1 int) ([]domain.Category, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCategoryRepositoryMockRecorder) FindAll(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindAll", reflect.TypeOf((*MockCategoryRepository)(nil).FindAll), arg0, arg1)
}
